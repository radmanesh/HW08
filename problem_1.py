...
eliteSolutions = int(populationSize * 0.02)  #currently not used in the implementation; need to use some type of elitism
...
#this is a simple mutation function that adds a small random number to each element of the chromosome
...
def main():
    ...
    for j in range(Generations):
        ...
        mates=tournamentSelection(Population,3)  #<--need to replace this with roulette wheel selection, e.g.:  mates=rouletteWheel(Population)
